...
/>
          ...
          <div className="space-y-2">
            ...
            <div className="rounded-md bg-gray-50" style={{ padding: s.padY }}>
              <div className="flex items-start gap-2">
                <UserPlusIcon className="text-red-600 mt-0.5" style={{ width: s.icon, height: s.icon }} />
            ...
            <div className="rounded-md bg-gray-50" style={{ padding: s.padY }}>
              <div className="flex items-start gap-2">
                <KeyIcon className="text-red-600 mt-0.5" style={{ width: s.icon, height: s.icon }} />
                <div className="text-center w-full" style={{ fontSize: s.note }}>
                  <p className="text-gray-700">
        ...
        {showForgot && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-sm" style={{ padding: s.cardPad }}>
